...
class test{
    ...
    public static void main(String[] args){
            ...
            test T = new test(args[0]); // THIS WILL CREATE YOUR BST AND FILL IT WITH THE INFORMATION FROM THE DATAFILE
 ...
 //           T.a.print(); // Prints titles of all elements in the bst sorted by keyword.
		...
		if(T.a.contains("learning"))
			System.out.println("Contains Learning");
		else
			System.out.println("Doesn't contain learning");

		if(T.a.contains("queries"))
			T.a.get_records("queries").print();
